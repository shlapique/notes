...
$$f_{X}(x) = \frac{1}{(2\pi)^{n}} \int\limits_{\R}e^{-i\lambda^{T} X}\psi_{X}(\lambda)d\lambda$$
...
\int\limits_{\R} e^{i\lambda_{1} x_{1}} \cdot \dots \cdot e^{i\lambda_{n}
...
\hat{\theta_{2}}(Z_{n})]$ --- называется ***дорверительным интервалом*** или ***интервальной оценкой***
...
## \underline{Построение доверительного интервала на основе центральной статитиски} {-}
...
Матрица $C \in \R^{n \times n}$ называется ***ортоногональной***, если $C^{T} = C^{-1}$.
